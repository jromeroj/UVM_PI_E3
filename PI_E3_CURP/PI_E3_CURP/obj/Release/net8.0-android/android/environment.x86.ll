...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 739405939, ; hash 0x2c127073, from name: libaot-PI_E3_CURP.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 948798144, ; hash 0x388d82c0, from name: aot-PI_E3_CURP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PI_E3_CURP.dll.so
		ptr null; void* handle (0x0)
	}, ; 101
	...
	%struct.DSOCacheEntry {
		i64 2736918858, ; hash 0xa322114a, from name: libaot-PI_E3_CURP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PI_E3_CURP.dll.so
		ptr null; void* handle (0x0)
	}, ; 316
	...
	%struct.DSOCacheEntry {
		i64 2928099915, ; hash 0xae87424b, from name: PI_E3_CURP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PI_E3_CURP.dll.so
		ptr null; void* handle (0x0)
	}, ; 339
	...
	%struct.DSOCacheEntry {
		i64 3559926428, ; hash 0xd4302a9c, from name: aot-PI_E3_CURP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PI_E3_CURP.dll.so
		ptr null; void* handle (0x0)
	}, ; 409
	...
	%struct.DSOCacheEntry {
		i64 4105785944, ; hash 0xf4b95258, from name: PI_E3_CURP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PI_E3_CURP.dll.so
		ptr null; void* handle (0x0)
	}, ; 469
